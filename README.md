...
[![Python Tests](https://github.com/a0ax/fastgeotoolkit/actions/workflows/python-tests.yml/badge.svg)](https://github.com/a0ax/fastgeotoolkit/actions/workflows/python-tests.yml)
...
The main use case is creating route heatmaps where you want to see which paths/routes are used most frequently. You can test this functionality at [https://fastgeotoolkit-demo.pages.dev/](https://fastgeotoolkit-demo.pages.dev/), using either your own data or sample data. 
...
npm test
```
Python tests are located in the github CI folder and are made to be ran after installing with pip
